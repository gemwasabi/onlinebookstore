  ...
  return (
    <><div className="bg-[#7B8E76] min-h-screen w-screen relative flex flex-col items-center justify-center">
        ...
        <div className="relative w-full max-w-[600px]">
          <input
            type="text"
            className={`w-full rounded-3xl border-4 border-[#ADBBAA] bg-[#BDC6BA] hover:drop-shadow-md p-2 outline-none placeholder:p-2 placeholder:text-left placeholder:font-sans placeholder:text-[#858B83] text-[#747474] px-5 hover:border-[#FFFFFF] hover:shadow active:border-[#FFFFFF] ${isActive ? '' : 'pr-12'}`}
